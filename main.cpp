...
hitable *random_scene() {
  ...
  list[0] = new sphere(vec3(0, -1000, 0), 1000,
                       new lambartian(vec3(0.109, 0.090, 0.090)));
  int i = 1;
  for (int a = 0; a < 7; a++) {
    for (int b = 0; b < 7; b++) {
      ...
      if ((center - vec3(4, 0.2, 0)).length() > 0.9) {
        if (choose_mat < 0.8) { // diffuse
          list[i++] = new moving_sphere(
              center, center + vec3(0.0f, 0.5f * drand48(), 0.0f), 0.0f, 1.0f,
              0.2f,
              new lambartian(vec3(drand48() * drand48(), drand48() * drand48(),
                                  drand48() * drand48())));
  ...
  // list[i++] = new sphere(vec3(-4, 1, 0), 1.0, new lambartian(vec3(0.4, 0.2,
  // 0.1)));
  list[i++] =
      new sphere(vec3(6, 0.6, 0), 0.7, new metal(vec3(0.7, 0.6, 0.5), 0.0));
